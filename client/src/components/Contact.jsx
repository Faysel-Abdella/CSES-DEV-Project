...
const Contact = () => {
  ...
  return (
    <>
      <section
        className="bg-dark py-20 px-8 lg:py-[120px] overflow-hidden relative z-10 font-poppins"
        id="contact"
      >
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div className="mb-12 max-w-[570px] lg:mb-0">
                ...
                <p className="text-base leading-relaxed mb-9 text-slate-400">
                  We are always available to hear from you. Contact us today to
                  discuss your thoughts. You can easily contact us with a direct
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div className="w-full">
                    ...
                    <p className="text-base text-slate-400">+251 9681 37473</p>
                  </div>
                </div>
                <div className="mb-8 flex w-full max-w-[370px]">
                  <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px]">
