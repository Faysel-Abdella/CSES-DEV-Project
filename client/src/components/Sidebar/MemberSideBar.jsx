  ...
  return (
    <section className="h-full bg-white py-12 fixed w-1/5 font-poppins">
      <ul className="mt-9 ml-8 space-y-4">
        ...
        <li className="py-2">
          <NavLink
            to="/member/dashboard/home/events"
            className={({ isActive }) =>
              "group flex font-medium items-center border-r-4 border-transparent rounded-sm " +
              (isActive
                ? "text-primary-default font-bold !border-primary-default"
        ...
        <li className="py-2">
          <NavLink
            to="/member/dashboard/home/opportunities"
            className={({ isActive }) =>
              "group flex font-medium items-center border-r-4 border-transparent rounded-sm " +
              (isActive
                ? "text-primary-default font-bold !border-primary-default"
        ...
        <li className="py-2">
          <NavLink
            to="/member/dashboard/home/notices"
            className={({ isActive }) =>
              "group flex font-medium items-center border-r-4 border-transparent rounded-sm " +
              (isActive
                ? "text-primary-default font-bold !border-primary-default"
        ...
        <li className="py-2">
          <NavLink
            to="/member/dashboard/home/profile"
            className={({ isActive }) =>
              "group flex font-medium items-center border-r-4 border-transparent rounded-sm " +
              (isActive
                ? "text-primary-default font-bold !border-primary-default"
      ...
      <a
        href="/"
        className="ml-8 fixed bottom-10 px-12 py-2 text-white font-bold rounded-full bg-primary-default"
      >
        Logout
      </a>
    </section>
